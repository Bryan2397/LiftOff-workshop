        ...
        <div style={styles.heroInner}>
          ...
          <div style={styles.summaryCard}>
            <div style={styles.summaryRow}>
              ...
              <div>
                <div style={styles.time}>{convert(flight.departureTime)}</div>
                <div style={styles.subtext}>{flight.fromCode}</div>
              </div>

              <div style={{ textAlign: "center" }}>
                <div style={styles.subtext}>{formatDuration(flight.departureTime, flight.arrivalTime)} </div>
              ...
              <div style={{ textAlign: "right" }}>
                <div style={styles.time}>{convert(flight.arrivalTime)}</div>
                <div style={styles.subtext}>{flight.toCode}</div>
              </div>
          ...
          <div style={styles.sectionCard}>
            ...
            <div style={styles.twoColumn}>
              ...
              <div>
                ...
                <p><strong>Address:</strong> {flight.addressFrom}</p>
